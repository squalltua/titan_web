...
(1,'admin admin','admin','$2y$10$WNDt4yDNMOoe048F5Bcs8uySw.JpNGcovRNHz.iYOPO5NmM7sGYHO','admin@titanscript.com','active','2024-12-25 11:03:41','2024-12-25 11:12:52',1);
...
(1,1,'Red','2024-12-25 11:13:37','2025-01-20 07:01:51'),
(2,1,'Blue','2024-12-25 11:13:44','2024-12-25 11:13:44'),
(3,1,'Green','2024-12-25 11:13:48','2024-12-25 11:13:48'),
(4,2,'64GB','2024-12-25 11:14:09','2024-12-25 11:14:09'),
(5,2,'128GB','2024-12-25 11:14:14','2024-12-25 11:14:14'),
(6,2,'256GB','2024-12-25 11:14:22','2024-12-25 11:14:22');
...
(1,'Color','2024-12-25 11:13:31','2025-01-17 10:19:12'),
(2,'Storage','2024-12-25 11:13:55','2024-12-25 11:13:55');
...
(1,'Smart Phone','Smart-Phone',NULL,1,2,0,'2024-12-25 11:14:34','2025-01-20 06:24:15');
...
(1,1,'test',NULL,'test','123123123','test@titanscript.com','test test',NULL,'2025-01-25 10:05:23','2025-01-25 10:05:23');
...
(1,'test test','29299597','test@titanscript.com','12 ddjdi','','didid','didid','sfsdf','989895',NULL,'sdfsdf',NULL,NULL,'individual','none','active','2025-01-25 10:05:23','2025-01-25 10:05:23');
...
(1,'News','news',NULL,1,2,NULL,'2024-12-26 11:00:39','2025-01-17 04:51:15'),
(2,'Game','game',NULL,3,4,NULL,'2024-12-27 05:37:45','2024-12-27 05:37:45');
...
(1,'th','Products',1,'title','ไอโฟน 30'),
(2,'th','MetaProducts',1,'meta_key','น้ำหนัก'),
(3,'th','MetaProducts',1,'meta_value','170 กรัม'),
(4,'th','Groups',1,'name',' ข่าว'),
(5,'th','Groups',1,'slug','khaw'),
(6,'th','Posts',2,'title','โพสต์ทดสอบ'),
(7,'th','Posts',2,'slug','phost-thdsxb'),
(8,'th','MetaPosts',6,'meta_value','Test posts'),
(9,'th','MetaPosts',7,'meta_value','Test posts'),
(10,'th','MetaPosts',8,'meta_value',''),
(11,'th','Attributes',1,'name','สี'),
(12,'th','Categories',1,'name','สมาร์ทโฟน'),
(13,'th','Categories',1,'slug','sma-rth-fon'),
(14,'th','AttributeOptions',1,'value','แดง'),
(15,'th','SiteSettings',1,'value_field','ชื่อเว็บไซต์'),
(16,'th','SiteSettings',2,'value_field',' '),
(17,'th','SiteSettings',3,'value_field',' '),
(18,'th','SiteSettings',4,'value_field',''),
(19,'th','SiteSettings',5,'value_field','');
...
(19,'iphone','/var/www/html/webroot/storage/24c513df-39cb-48b4-a262-c6b7f36dae44.jpg',6925,'image/jpeg',NULL,'feature_image','iphone',NULL,'iphone',0,'https://titan-web.ddev.site/api/v1/medias/images/iphone','24c513df-39cb-48b4-a262-c6b7f36dae44','2025-01-17 03:52:58','2025-01-17 03:52:58');
...
INSERT INTO `meta_posts` VALUES
(6,2,'og_tag_title','Test posts'),
(7,2,'og_tag_description','Test posts'),
(8,2,'og_tag_url','');
...
INSERT INTO `meta_products` VALUES
(1,1,'Weight','170 g.'),
(2,1,'Height','147.6 mm.'),
(3,1,'Screen','Super Retina XDR OLED 6.1\"');
...
(2,'Test posts','test-posts','Test posts','# Test posts',NULL,'published',NULL,'2025-01-17 05:23:56','2025-01-17 08:25:33',1);
...
INSERT INTO `posts_groups` VALUES
(2,1);
...
(1,'iPhone 30','iPhone-30','iPhone 30 for the future','iPhone 30 for the future',0.00,0.00,0.00,NULL,NULL,NULL,1,1,NULL,'active','2024-12-26 08:04:52','2025-01-15 08:11:24');
...
INSERT INTO `products_medias` VALUES
(1,19);
...
(1,'Admin','admin','active',NULL,NULL,'2024-12-25 11:03:41','2024-12-25 11:03:41'),
(2,'Staff','staff','active',NULL,NULL,'2024-12-25 11:03:41','2024-12-25 11:03:41');
...
(8,'sns_twitter_name',' '),
(9,'sns_twitter_url',' '),
(10,'sns_instagram_name',' '),
(11,'sns_instagram_url',' '),
(12,'sns_tiktok_name',' '),
(13,'sns_tiktok_url',' ');
...
(1,1,'iphone 30','iphone-30','12344',29900.00,29900.00,0.00,19,'active','2024-12-26 08:23:04','2025-01-17 04:03:35'),
(2,1,'iPhone 30','iPhone-30','12345',29900.00,29900.00,0.00,19,'active','2024-12-26 08:25:07','2024-12-26 08:31:43');
...
INSERT INTO `variants_attribute_options` VALUES
(1,1),
(1,6),
(2,1),
(2,5);
...
-- Dump completed on 2025-02-03 11:14:26
