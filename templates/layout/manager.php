...
<head>
    ...
    <?= $this->Html->css([
        ...
        '/vendor/tabler-v1.0.0-beta20/dist/css/demo.min.css',
        'main.css',
    ]) ?>
    <style>
...
<body class="layout-fluid">
    <?= $this->Html->script('/vendor/tabler-v1.0.0-beta20/dist/js/demo-theme.min.js') ?>
    <div class="page">
        <?= $this->element('header') ?>
    ...
    <?= $this->Html->script([
        ...
        '/vendor/tabler-v1.0.0-beta20/dist/js/demo.min.js',
