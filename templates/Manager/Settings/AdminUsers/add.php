            ...
            <div class="col-12 col-md-8 col-lg-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            <label for="role-id" class="form-label required"><?= __('Role') ?></label>
                            <?= $this->Form->select('role_id', $roles, ['class' => 'form-select', 'id' => 'role-id', 'required' => true]) ?>
                        </div>
                        <div class="mb-3">
                    ...
                    <div class="card-footer text-end">
                        <div class="d-flex">
                            <?= $this->Html->link(__('Cancel'), '/manager/settings/admin-users', ['class' => 'btn btn-link']) ?>
