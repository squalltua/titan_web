    ...
    <div class="card-body">
        <div class="d-flex mb-2">
            <div class="flex-grow-1">
                <h4><?= __('Users :: Change password') ?></h4>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-6">
                <div class="form-group mb-3">
                    <label for="username_display" class="form-label"><?= __('Username') ?></label>
                    <?= $this->Form->text('username_display', ['class' => 'form-control form-control-sm', 'id' => 'username_display', 'disabled' => true, 'readonly' => true, 'value' => h($user->username)]) ?>
                </div>
                <div class="form-group mb-3">
                    <label for="password" class="form-label"><?= __('Password') ?></label>
                    <?= $this->Form->password('password', ['class' => 'password-input form-control form-control-sm', 'id' => 'password', 'required' => true, 'value' => '', 'placeholder' => __('Enter new password')]) ?>
                ...
                <div class="mt-4">
                    ...
                    <?= $this->Html->link(__('Back'), "/manager/settings/users/edit/{$user->id}", ['class' => 'btn btn-secondary btn']) ?>
                </div>
            </div>
        </div>
        <?= $this->Form->end() ?>
