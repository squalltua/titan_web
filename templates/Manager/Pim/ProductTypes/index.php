<div class="row">
    <div class="col">
        <h4>
            <?= __('Product Types') ?>
            <?= $this->Html->link(__('New'), '/manager/pim/product-types/add', ['class' => 'btn btn-primary btn-sm ms-3']) ?>
        </h4>
    </div>
</div>
        ...
        <?php else: ?>
            <div class="p-2 mb-4">
                <div class="container-fluid py-5 text-muted text-center">
                    ...
                    <?= $this->Html->link(__('New'), '/manager/pim/product-types/add', ['class' => 'btn btn-secondary btn-lg ms-3']) ?>
                </div>
            </div>
        <?php endif ?>
    </div>
