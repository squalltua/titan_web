        ...
        <div class="row">
            <div class="col-12 col-md-8 col-lg-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="mb-3 row">
                            <label for="value" class="col-3 col-form-label required"><?= __('Value') ?></label>
                            <div class="col">
                                <?= $this->Form->text('value', ['class' => 'form-control', 'id' => 'value']) ?>
                            </div>
                        </div>
                    </div>
                    <div class="card-footer text-end">
                        <div class="d-flex">
                            <?= $this->Html->link(__('Cancel'), "/manager/pim/variant-options/edit/{$attribute->id}", ['class' => 'btn btn-link']) ?>
