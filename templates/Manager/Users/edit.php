                ...
                <div class="mt-4">
                    <div class="d-flex justify-content-between">
                        <div>
                            ...
                            <?= $this->Html->link(__('Back'), "/manager/users", ['class' => 'btn btn-secondary']) ?>
                        </div>
                        <div>
                            <?= $this->Form->postLink(__('Delete'), "/manager/users/delete/{$user->id}", ['class' => 'btn btn-danger', 'confirm' => __('Do you want delete this data?')]) ?>
                            <?= $this->Html->link(__('Change password'), "/manager/users/change-password/{$user->id}", ['class' => 'btn btn-secondary']) ?>
                        </div>
                    </div>
                </div>
            </div>
