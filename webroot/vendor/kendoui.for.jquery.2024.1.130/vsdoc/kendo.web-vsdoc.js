...
kendo.ui.ActionSheet.prototype = {
    ...
    visible: function() {
        ...
        /// </summary>
        /// <returns type="Boolean">True when the actionsheet is visible</returns>
...
kendo.ui.Badge.prototype = {
    ...
    rounded: function(rounded) {
        ...
        /// </summary>
        /// <param name="rounded" type="String" >The new rounding of the badge.</param>
...
$.fn.kendoBadge = function(options) {
    ...
    /// &#10;Specifies the theme color of the component. Valid options are inherit: no coloring will be applied to the badge. Useful when the badge needs to blend-in with the surrounding elements.; default: apply coloring based on surface theme color.; primary:  apply coloring based on primary theme color.; secondary: apply coloring based on secondary theme color.; tertiary: apply coloring based on tertiary theme color.; info: apply coloring based on info theme color.; success: apply coloring based on success theme color.; warning:apply coloring based on warning theme color.; error: apply coloring based on error theme color.; dark: apply coloring based on dark theme color.; light: always coloring based on light theme color. or inverse: depending on the luminance of the theme, light or dark, inverse will be dark or light..
    /// &#10;
...
kendo.ui.Chip = function() { };

kendo.ui.Chip.prototype = {
    ...
    select: function(state) {
        ...
        /// Selects the widget.
        /// </summary>
        /// <param name="state" type="Boolean" >If set to true the widget will be selected. If set to false the widget will be deselected.</param>
...
$.fn.getKendoChip = function() {
    /// <summary>
    /// Returns a reference to the kendo.ui.Chip widget, instantiated on the selector.
    /// </summary>
    /// <returns type="kendo.ui.Chip">The kendo.ui.Chip instance (if present).</returns>
};

$.fn.kendoChip = function(options) {
    /// <summary>
    /// Instantiates a kendo.ui.Chip widget based the DOM elements that match the selector.
...
kendo.ui.ChipList = function() { };

kendo.ui.ChipList.prototype = {
    ...
    enable: function(element,state) {
        ...
        /// Toggles item's enabled state.
        /// </summary>
        /// <param name="element" type="Object" >Specifies an existing item element in the ChipList.</param>
        /// <param name="state" type="Boolean" >Specifies the state of the element.</param>
...
$.fn.getKendoChipList = function() {
    /// <summary>
    /// Returns a reference to the kendo.ui.ChipList widget, instantiated on the selector.
    /// </summary>
    /// <returns type="kendo.ui.ChipList">The kendo.ui.ChipList instance (if present).</returns>
};

$.fn.kendoChipList = function(options) {
    /// <summary>
    /// Instantiates a kendo.ui.ChipList widget based the DOM elements that match the selector.
...
kendo.ui.DockManager = function() { };

kendo.ui.DockManager.prototype = {
    ...
    togglePane: function(id) {
        ...
        /// </summary>
        /// <param name="id" type="String" >The id assigned as a configuration option of the pane.</param>
...
$.fn.getKendoDockManager = function() {
    /// <summary>
    /// Returns a reference to the kendo.ui.DockManager widget, instantiated on the selector.
    /// </summary>
    /// <returns type="kendo.ui.DockManager">The kendo.ui.DockManager instance (if present).</returns>
};

$.fn.kendoDockManager = function(options) {
    /// <summary>
    /// Instantiates a kendo.ui.DockManager widget based the DOM elements that match the selector.
...
kendo.ui.Grid.prototype = {
    ...
    hideColumn: function(column) {
        ...
        /// </summary>
        /// <param name="column" type="Object" >The index of the column, or the field to which the columns is bound, or the column object obtained from the columns collection.When using multicolumn headers, using an index will hide a top-level column together with all its "child columns". In such scenarios, using field names or column objects may be more appropriate.</param>
...
$.fn.kendoGrid = function(options) {
    ...
    /// &#10;
    /// &#10;contextMenu - Object (default: false)
    /// &#10;Configures the ContextMenus of the Grid.
    /// &#10;
    /// &#10;dataSource - Object|Array|kendo.data.DataSource 
    ...
    /// &#10;
    /// &#10;size - String (default: "medium")
    /// &#10;Sets a value controlling size of the component. Can also be set to the following string values: "small"; "medium" or "large".
    /// &#10;
...
$.fn.kendoResponsivePanel = function(options) {
    ...
    /// &#10;Specifies the nonce attribute that will be set to the inline style injected in the  tag containing the dynamic media query styles.
    /// &#10;
...
kendo.ui.Signature = function() { };

kendo.ui.Signature.prototype = {
...
$.fn.getKendoSignature = function() {
    /// <summary>
    /// Returns a reference to the kendo.ui.Signature widget, instantiated on the selector.
    /// </summary>
    /// <returns type="kendo.ui.Signature">The kendo.ui.Signature instance (if present).</returns>
};

$.fn.kendoSignature = function(options) {
    /// <summary>
    /// Instantiates a kendo.ui.Signature widget based the DOM elements that match the selector.
...
kendo.ui.TimeDurationPicker = function() { };

kendo.ui.TimeDurationPicker.prototype = {
    ...
    value: function(value) {
        ...
        /// Gets or sets the value of the widget.
        /// </summary>
        /// <param name="value" type="Number" >The value to set in milliseconds.</param>
        /// <returns type="Number">the value of the widget.</returns>
...
$.fn.getKendoTimeDurationPicker = function() {
    /// <summary>
    /// Returns a reference to the kendo.ui.TimeDurationPicker widget, instantiated on the selector.
    /// </summary>
    /// <returns type="kendo.ui.TimeDurationPicker">The kendo.ui.TimeDurationPicker instance (if present).</returns>
};

$.fn.kendoTimeDurationPicker = function(options) {
    /// <summary>
    /// Instantiates a kendo.ui.TimeDurationPicker widget based the DOM elements that match the selector.
...
kendo.ui.ToggleButton = function() { };

kendo.ui.ToggleButton.prototype = {
    ...
    toggle: function(toggle) {
        ...
        /// </summary>
        /// <param name="toggle" type="Boolean" >Indicates whether the ToggleButton should be selected or deselected. true and false arguments are accepted. If no argument is supplied, the ToggleButton will toggle its current state to the opposite value.</param>
...
$.fn.getKendoToggleButton = function() {
    /// <summary>
    /// Returns a reference to the kendo.ui.ToggleButton widget, instantiated on the selector.
    /// </summary>
    /// <returns type="kendo.ui.ToggleButton">The kendo.ui.ToggleButton instance (if present).</returns>
};

$.fn.kendoToggleButton = function(options) {
    /// <summary>
    /// Instantiates a kendo.ui.ToggleButton widget based the DOM elements that match the selector.
...
kendo.ui.TreeView.prototype = {
    ...
    scrollTo: function(node) {
        ...
        /// </summary>
        /// <param name="node" type="jQuery" >The node to which the TreeView should scroll and make it visible.</param>
...
$.fn.kendoTreeView = function(options) {
    ...
    /// &#10;
    /// &#10;dragAndDrop - Object (default: false)
    /// &#10;Disables (false) or enables (true) drag-and-drop of the nodes. If configured as an object allows disabling click move click interaction as an alternative of dragging.
    /// &#10;
    /// &#10;loadOnDemand - Boolean (default: true)
    /// &#10;Indicates whether the child DataSources should be fetched lazily when parent groups get expanded. Setting this to false causes all child DataSources to be loaded at initialization time.
